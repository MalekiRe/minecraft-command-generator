...
public class DragAndDropWidgetMenu extends JPanel implements MouseInputListener
{
   ...
   {  
      ...
      {
         if(cumulativeWidth+this.widgetsOnPanel.get(i1).getWidth() <= this.getWidth())
         {  
   ...
   {  
      ...
      DragAndDropWidgetHolder myWidgetPane = new DragAndDropWidgetHolder(400, 400, Color.GREEN, allWidgetBlocks);
      
      CommandWidget setBlockCommand = new CommandWidget("/setblock", new VariableTemplate("Block", ""), new VariableTemplate("Cords", ""));
      myWidgetPane.getPane().addCommandWidget(setBlockCommand);
